...
{
    /// <inheritdoc />
    public partial class HDS : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudentAcademicYearId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    AcademicYearId = table.Column<int>(type: "int", nullable: false),
                    Paid1 = table.Column<bool>(type: "bit", nullable: false),
                    Paid2 = table.Column<bool>(type: "bit", nullable: false),
                    Paid3 = table.Column<bool>(type: "bit", nullable: false),
                    Paid4 = table.Column<bool>(type: "bit", nullable: false),
                    Paid5 = table.Column<bool>(type: "bit", nullable: false),
                    Paid6 = table.Column<bool>(type: "bit", nullable: false),
                    Paid7 = table.Column<bool>(type: "bit", nullable: false),
                    Paid8 = table.Column<bool>(type: "bit", nullable: false),
                    Paid9 = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAcademicYears", x => x.StudentAcademicYearId);
                    table.ForeignKey(
                        name: "FK_StudentAcademicYears_AcademicYears_AcademicYearId",
                        column: x => x.AcademicYearId,
                        principalTable: "AcademicYears",
                        principalColumn: "AcademicYearId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAcademicYears_AcademicYearId",
                table: "StudentAcademicYears",
                column: "AcademicYearId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentAcademicYears_StudentId_AcademicYearId",
                table: "StudentAcademicYears",
